...
const plans = [
  { name: 'Free', price: '$0/mo', features: ['100 inferences/hr', 'fp16 precision only', '1 model deployment', 'Community support'] },
  { name: 'Pro', price: '$199/mo', features: ['10,000 inferences/hr', '1.58-bit ternary quantization', '10 model deployments', 'Benchmark suite', '90% energy savings', 'Priority support'] },
  { name: 'Enterprise', price: 'Custom', features: ['Unlimited inferences', 'Custom precision levels', 'Unlimited deployments', 'On-premise option', 'SLA 99.99%', 'Dedicated support'] },
];
